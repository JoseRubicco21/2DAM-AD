 ...
 * principalmente orientada a MySQL. Implementa la interfaz GenericConnector y ofrece
...
public class SQLConnector implements GenericConnector {
     ...
     * @param url La URL completa de conexión JDBC (ej: jdbc:mysql://localhost:3306/database)
